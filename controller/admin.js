...
exports.postOrder = (req, res, next) => {
    if(true){
        ...
        order.save().then(result=>{
            ...
            // res.redirect('/recipt');
            res.render('Recipt', { service: service, name: name, phone: phone, amount: amount, payment: payment, date: date, location: location, people: people, product: product, id: id,price:price,username: username });
        }).catch(err=>{
            console.log(err);
        })
    }
